...
if request == 1:
    ...
    print("This is in Passwords.txt after appending...\n") 
...
Please tell me in numbers... "))
    ...
    passwords = open("Passwords.txt", "r") 
    print("\nThis is in Passwords.txt after appending...\n") 
    print(passwords.read()) 
    print() 
    passwords.close() 

elif request == 3:
    print("\nThank you for using this little program, hope it was useful!")

else:
    print("\nError you typed a(n) wrong input, \
